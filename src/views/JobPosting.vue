  ...
  <div class="lg:grid lg:grid-cols-6">
    ...
    <section class="mt-8 lg:mt-0 lg:col-span-5">
      ...
      <div class="flex justify-start mt-8">
        <img :src="imageUrl" alt="profile image" class="self-start object-cover job-thumbnail" />
        <div class="ml-3">
          <div class="flex flex-col justify-between h-full">
            <h2 class="font-sans font-bold text-lg text-indigo-700">{{company}}</h2>
            <div class="inline-flex">
              ...
              <h3 class="font-sans font-medium text-gray-500 text-xs ml-2 align-middle">{{location}}</h3>
            </div>
          </div>
        </div>
      </div>
